...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final String COL_COURSE_STUDENT_ID = "student_id"; // Foreign key
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String createStudentDetailsTable = "CREATE TABLE " + TABLE_STUDENT_DETAILS + " (" +
        ...
        String createStudentCoursesTable = "CREATE TABLE " + TABLE_STUDENT_COURSES + " (" +
                ...
                COL_COURSE_STUDENT_ID + " TEXT NOT NULL, " +
        ...
        db.execSQL(createStudentDetailsTable);
    ...
    public long insertStudent(Student student) {
        ...
        if (student.getPhoto() != null) {
            values.put(COL_PHOTO, getBitmapAsByteArray(student.getPhoto()));
        }
    ...
    public int deleteStudent(String studentId) {
        SQLiteDatabase db = this.getWritableDatabase();
        // Delete courses first (foreign key constraint)
        db.delete(TABLE_STUDENT_COURSES, COL_COURSE_STUDENT_ID + "=?", new String[]{studentId});
        int result = db.delete(TABLE_STUDENT_DETAILS, COL_STUDENT_ID + "=?", new String[]{studentId});
        db.close();
        return result;
    }
    ...
    public Student getStudent(String studentId) {
        ...
        Cursor cursor = db.query(TABLE_STUDENT_DETAILS, null, 
                COL_STUDENT_ID + "=?", new String[]{studentId}, null, null, null);
    ...
    public List<Student> getAllStudents() {
        ...
        SQLiteDatabase db = this.getReadableDatabase();
        Cursor cursor = db.query(TABLE_STUDENT_DETAILS, null, null, null, null, null, 
    ...
    private Student cursorToStudent(Cursor cursor) {
        ...
        if (photoBytes != null && photoBytes.length > 0) {
            student.setPhoto(BitmapFactory.decodeByteArray(photoBytes, 0, photoBytes.length));
        }
    ...
    public int updateCourse(Course course) {
        ...
        int result = db.update(TABLE_STUDENT_COURSES, values, 
                COL_COURSE_ID + "=?", new String[]{String.valueOf(course.getCourseId())});
        db.close();
        return result;
    }
    ...
    public int deleteCourse(int courseId) {
        SQLiteDatabase db = this.getWritableDatabase();
        int result = db.delete(TABLE_STUDENT_COURSES, COL_COURSE_ID + "=?", 
    ...
    public List<Course> getCoursesByStudentId(String studentId) {
        ...
        Cursor cursor = db.query(TABLE_STUDENT_COURSES, null, 
                COL_COURSE_STUDENT_ID + "=?", new String[]{studentId}, null, null, 
                COL_COURSE_NAME + " ASC");
        ...
        if (cursor != null && cursor.moveToFirst()) {
            do {
                ...
                course.setStudentId(cursor.getString(cursor.getColumnIndexOrThrow(COL_COURSE_STUDENT_ID)));
                ...
                course.setCredits(cursor.getInt(cursor.getColumnIndexOrThrow(COL_COURSE_CREDITS)));
                course.setGrade(cursor.getString(cursor.getColumnIndexOrThrow(COL_COURSE_GRADE)));
                courses.add(course);
            } while (cursor.moveToNext());
            cursor.close();
        }
